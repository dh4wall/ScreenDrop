...
export const BUNNY = {
  STREAM_BASE_URL: "https://video.bunnycdn.com/library",
  STORAGE_BASE_URL: "https://storage.bunnycdn.com/screendrop",
  CDN_URL: "https://ScreenDrop.b-cdn.net",
  EMBED_URL: "https://iframe.mediadelivery.net/embed",
  TRANSCRIPT_URL: "https://vz-226aac34-a84.b-cdn.net",
};
...
// export const visibilities: Visibility[] = ["public", "private"];
export const visibilities: string = "string";
